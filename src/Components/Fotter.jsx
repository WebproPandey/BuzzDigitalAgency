...
const Fotter = () => {
  return (
    <div className="min-h-screen  w-full bg-[#090214] pt-[4rem]  ">
        <div className="flex  justify-center items-start border-t border-white/20 py-[4rem] px-[3vw]">
          <div className="w-[35%]     gap-6">
        <div className="leftlogo w-[20vw]  h-full flex items-center  justify-start  ">
          <img
            src={logo}
            className="h-[10vh]  w-[14vw] object-contain"
            alt=""
          />
        </div>
        <div className="w-full text-white/80 text-[1.3vw]">
        ...
        <div className="w-full text-white/80  cursor-pointer  py-6 ">
           <div className="flex gap-2  items-center"><i className="ri-mail-line"></i> <h1 className="text-[1.2vw] hover:text-[#FD7EC1]">info@buzzdigitalagency.com</h1></div>
           <div className="flex gap-2  items-center"><i className="ri-phone-fill"></i> <h1 className="text-[1.2vw] hover:text-[#FD7EC1]">(888) 009 4493</h1></div>
           <div className="flex gap-2  items-center"><i className="ri-focus-3-fill"></i> <h1 className="text-[1.2vw] hover:text-[#FD7EC1]">1535 west Loop s, ste  450, houston , Tx,  62720</h1></div>
        </div>
        <div className="sociallink w-full flex justify-start gap-3 items-center">
            <div className="h-[7vh] w-[7vh] rounded-full bg-[#7458a1]/40 flex items-center  justify-center">
            <i className="ri-facebook-fill text-white text-[1.8vw]"></i>
            </div>
            <div className="h-[7vh] w-[7vh] rounded-full bg-[#7458a1]/40 flex items-center  justify-center">
            <i className="ri-instagram-fill text-white text-[1.8vw]"></i>
            </div>
            <div className="h-[7vh] w-[7vh] rounded-full bg-[#7458a1]/40 flex items-center  justify-center">
            <i className="ri-twitter-x-fill text-white text-[1.8vw]"></i>
            </div>
            <div className="h-[7vh] w-[7vh] rounded-full bg-[#7458a1]/40 flex items-center  justify-center">
            <i className="ri-google-fill text-white text-[1.8vw]"></i>
            </div>
            <div className="h-[7vh] w-[7vh] rounded-full bg-[#7458a1]/40 flex items-center  justify-center">
            <i className="ri-youtube-fill text-white text-[1.8vw]"></i>
            </div>
            <div className="h-[7vh] w-[7vh] rounded-full bg-[#7458a1]/40 flex items-center  justify-center">
            <i className="ri-linkedin-fill text-white text-[1.8vw]"></i>
            </div>
            <div className="h-[7vh] w-[7vh] rounded-full bg-[#7458a1]/40 flex items-center  justify-center">
            <i className="ri-tiktok-fill text-white text-[1.8vw]"></i>
            </div>
          ...
          <div className="w-[70%] grid grid-cols-3 pl-[3vw]  gap-x-8  ">
      ...
      <h1 className="hover:text-[#FD7EC1] text-[1.2vw]">Copyright © 2025 Buzz Digital Agency, All rights reserved.</h1>
         <div className="flex items-center gap-4 ">
            <h1 className="hover:text-[#FD7EC1]  text-[1.2vw]">Terms and Services</h1>
            <h1 className="hover:text-[#FD7EC1]  text-[1.2vw] pr-[3vw]">Privacy</h1>
         </div>
      </div>
      </div>
