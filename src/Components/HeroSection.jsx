    ...
    <div className="min-h-screen w-full ">
      <div className="heroTop relative h-[90vh] w-full  ">
        ...
        <div className="relative z-10 flex gap-4 leading-none flex-col items-center md:justify-center pt-10  h-[80vh]  ">
          <div className="text-white text-[3vw] md:text-[1.1vw] rounded-full border  px-6  py-2 font-medium uppercase ">
          ...
          <div className="mt-5 w-[85%] md:w-[50%] leading-5">
      ...
      <div className="heroBottom  w-full bg-[#1C142A] relative  pb-[10rem]">
        <div className="businessesPartner absolute z-[99] -top-[15%] md:-top-[20%] px-[6vw]  md:px-[8vw]  flex  flex-col  gap-9 justify-center items-center w-[95%] left-1/2 -translate-x-1/2 h-[60vh] md:h-[70vh] bg-[#1C142A] border rounded-lg">
           <div className="h-1/2  w-[20%] absolute bg-[radial-gradient(closest-side,_#B47CFD,_#FF7FC2)] rounded-full blur-[50px] "></div>
          <div className="w-full md:w-[50%] text-[6vw] md:text-[2.6vw] text-center text-white font-bold leading-none">
        ...
        <div className="w-full  ">
          <div className=" full flex-col gap-10 md:gap-0 md:flex-row flex justify-center  items-center   pt-[12rem] md:pt-[25rem]  px-[4vw] ">
            <div className="md:h-screen h-[50vh] w-full md:w-1/2 p-4 border-[1px] rounded-lg  overflow-hidden ">
              <img
            ...
            <div className="about h-screen  w-full  md:w-1/2 pl-0 md:pl-[4rem] flex flex-col gap-3  ">
              ...
              <div className="button w-full  md:px-8 md:py-[10px] py-[8px] text-center md:w-fit bg-gradient-to-r from-[#F77FC9] to-[#BC7CF6] hover:from-[#BC7CF6] hover:to-[#F77FC9] hover:shadow-xl transition-all duration-300 ease-in-out text-white border rounded-full uppercase font-medium">get Started</div>
