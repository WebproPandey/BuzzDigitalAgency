...
const Navbar = () => {
  ...
  return (
    <div className=" md:h-[18vh] h-[15vh] border-gray-200 sticky top-0 left-0 z-[9999] flex justify-between md:px-10 px-[4vw] py-[2vw] bg-transparent">
      <div className="line w-full bottom-0 left-0 absolute md:px-10">
        <div className="h-[0.1rem] w-full bg-gray-100/20"></div>
      </div>

      <div className="leftlogo md:w-[20vw] h-full flex items-end justify-start">
        <img
          src={logo}
      ...
      <div className="rightside w-fit md:flex items-center justify-end gap-8 relative hidden">
        ...
        <div className="button px-8 py-[6px] text-white border bg-gradient-to-r from-[#F77FC9] to-[#BC7CF6] hover:from-[#BC7CF6] hover:to-[#F77FC9] hover:shadow-xl transition-all duration-300 ease-in-out rounded-full uppercase font-medium">
          Get Started
        </div>
      </div>

      {/* Mobile Menu Icon */}
      <div className="h-full flex items-center justify-start relative md:hidden">
      ...
      {isMobileMenuOpen && (
        <div
          className={`fixed top-[15vh] left-0 w-full bg-[#1C142A] overflow-hidden transition-all duration-[5s] ease-in-out z-[9999]
      ${isMobileMenuOpen ? "max-h-[90vh]" : "max-h-0"}
    `}
        >
